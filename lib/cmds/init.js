...
exports._initAUI = function(mainCallback) {
    ...
    buildCmd.buildYUI(srcDir, buildDir, 'Do you wish to build AlloyUI', alloyJSON.version, true, true, false, mainCallback);
};
...
exports._initYUI = function(dependency, mainCallback) {
    ...
    buildCmd.buildYUI(srcDir, buildDir, 'Do you wish to build YUI', alloyJSON['yui-version'], true, true, false, mainCallback);
};