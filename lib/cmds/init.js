...
exports._buildYUI = function(srcDir, buildDir, message, version, mainCallback) {
    prompt(message + ' [' + buildDir + ']? [y/N] ', function(ans) {
        if (ans.toLowerCase() === 'y') {
            ...
            command.open(root)
                ...
                .exec('shifter', ['--build-dir', buildDir, '--walk', '--replace-version=' + version ], { cwd: srcDir })
                .then(function() {
                    mainCallback();
                });
        }
...
exports._initAUI = function(mainCallback) {
    ...
    exports._buildYUI(srcDir, buildDir, 'Do you wish to do a full Alloy build into alloy build folder', alloyJSON['version'], mainCallback);
};
...
exports._initYUI = function(dependency, mainCallback) {
    ...
    exports._buildYUI(srcDir, buildDir, 'Do you wish to do a full YUI build into alloy build folder', alloyJSON['yui-version'], mainCallback);
};
