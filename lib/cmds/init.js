...
exports._initAUI = function(mainCallback) {
    ...
    exports._buildYUI(srcDir, buildDir, 'Do you wish to build AlloyUI', alloyJSON['version'], mainCallback);
};
...
exports._initCSS = function(mainCallback) {
    prompt('Do you wish to import ' + base.TWITTER_BOOTSTRAP +
        ...
        if (ans.toLowerCase() === 'y') {
            command.open(root)
                .on('stdout', command.writeTo(process.stdout))
                .exec('yogi', ['alloy', '--import-css'], { cwd: root })
                .then(function() {
                    mainCallback();
                });
        }
...
exports._initYUI = function(dependency, mainCallback) {
    ...
    exports._buildYUI(srcDir, buildDir, 'Do you wish to build YUI', alloyJSON['yui-version'], mainCallback);
};
