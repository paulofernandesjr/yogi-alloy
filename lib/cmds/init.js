...
exports._initAUI = function(mainCallback) {
    ...
    exports.buildYUI(srcDir, buildDir, 'Do you wish to build AlloyUI', alloyJSON.version, true, false, mainCallback);
};
...
exports._initYUI = function(dependency, mainCallback) {
    ...
    exports.buildYUI(srcDir, buildDir, 'Do you wish to build YUI', alloyJSON['yui-version'], true, false, mainCallback);
};
