...
exports.run = function(options) {
    ...
    if (options.aui) {
        ...
        stack.push(function(mainCallback) {
            exports.buildYUI(cwd, buildDir, null, alloyJSON.version, fast, walk, watch, mainCallback);
        });
    }
    ...
    if (options.loader) {
        ...
        stack.push(function(mainCallback) {
            exports.buildYUI(auiBaseDir, buildDir, null, alloyJSON.version, fast, walk, watch, mainCallback);
        });
    }
    ...
    if (options.yui) {
        ...
        stack.push(function(mainCallback) {
            exports.buildYUI(yuiSrcDir, buildDir, null, alloyJSON['yui-version'], fast, walk, watch, mainCallback);
        });
    }
